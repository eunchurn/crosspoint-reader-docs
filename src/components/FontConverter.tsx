...
const DEFAULT_ENABLED_RANGES = UNICODE_RANGES.filter(
  (r) => r.defaultEnabled,
).map((r) => r.id);
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-sm font-medium text-amber-800 dark:text-amber-200">
                  대용량 폰트나 복잡한 글리프 변환이 필요한 경우
                </h4>
                <p className="mt-1 text-sm text-amber-700 dark:text-amber-300">
                  웹 변환기는 10MB 파일 크기 제한과 브라우저 메모리 한계가
                  있습니다. 제한 없이 변환하려면 Python 스크립트를 사용하세요.
                </p>
                <a
                  href="/korean-font#python-conversion"
                  className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-amber-800 dark:text-amber-200 hover:text-amber-900 dark:hover:text-amber-100"
                >
                  Python 스크립트 사용법
                  <svg
                    className="w-4 h-4"
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={charSpacing}
                      onChange={(e) =>
                        setCharSpacing(parseInt(e.target.value) || 0)
                      }
                      min={-10}
                      max={50}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={lineSpacing}
                      onChange={(e) =>
                        setLineSpacing(parseFloat(e.target.value) || 1)
                      }
                      min={0.5}
                      max={3}
                      step={0.1}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setHorizontalScale(parseInt(e.target.value) || 100)
                      }
                      min={50}
                      max={200}
                      className="w-full px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={baselineShift}
                      onChange={(e) =>
                        setBaselineShift(parseInt(e.target.value) || 0)
                      }
                      min={-20}
                      max={20}
                      className="w-full px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded
              ...
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  프리셋을 클릭하여 켜고 끌 수 있습니다. 여러 프리셋을 동시에
                  선택할 수 있습니다.
                </p>
              </div>
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                >
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      setIsUnicodeRangesOpen(!isUnicodeRangesOpen);
                    }}
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div className="flex gap-1">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setPreviewBgColor("#000000");
                        setPreviewFgColor("#ffffff");
                      }}
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                      onClick={() =>
                        setPreviewScale((s) => Math.max(0.25, s - 0.25))
                      }
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setPreviewScale((s) => Math.min(2, s + 0.25))
                      }
                      className="px-2 py-1 text-sm bg-gray-200 dark:bg-gray-700 rounded hover:bg-gray-300 dark:hover:bg-gray-600"
                    >
                      +
