    ...
    async (e: React.DragEvent) => {
      ...
      if (!["ttf", "otf", "woff", "woff2"].includes(ext || "")) {
        setConversionState({
          status: "error",
          progress: 0,
          message: "지원하지 않는 파일 형식입니다. TTF, OTF, WOFF, WOFF2 파일만 사용 가능합니다.",
        });
        return;
      }
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                {isDragging ? (
                  <span className="text-blue-600 dark:text-blue-400 font-medium">파일을 놓으세요</span>
                ) : (
                  <>
                    <span className="text-blue-600 dark:text-blue-400 font-medium">파일 선택</span>
                    {" 또는 드래그 앤 드롭"}
                  </>
                )}
              </div>
